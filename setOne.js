...
// CODE HERE
const problem2 = (parameter1, parameter2) => {
    return console.log(`The first parameter is ${parameter1}. The second parameter is ${parameter2}`)
}
...
cb(firstName + " mc" + lastName)
}
// INVOKE 'GREETING FUNCTION' HERE

let fullName = fullname => console.log(fullname);
greeting("Daniel", "Swag", fullName)
